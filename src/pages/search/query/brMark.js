 ...
 */
 ...
 class BrMark extends Component {
     static defaultProps = {
         templateData: null,
         templateValus: {
             cell: "",
     ...
     componentDidMount() {
         this.props.action.fetchInnerprodsTempDetail(MAP.SEARCHSELECT_ID_MAP.PERSONAL['百融评分']);
     }
     ...
     handleOk() {
         ...
         this.props.action.clearMessage();
         this.props.action.clearTemplateData();
         this.props.action.fetchTemplateDataSearch(MAP.SEARCHSELECT_ID_MAP.PERSONAL['百融评分'], values);
     }
     ...
     get report() {
         ...
         if(!templateData)
             return;
         return (<Report.brMark dataSource={{
             ...templateData.data,
             ...{
                 base: {
 ...
 export default connect(mapStateToProps, mapDispatchToProps)(createForm()(BrMark));
