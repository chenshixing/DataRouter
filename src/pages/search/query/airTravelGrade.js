...
class AirTravelGrade extends Component {
    static defaultProps = {
        templateData: null,
        templateValus: {
            cell: "",
    ...
    componentDidMount() {
        this.props.action.fetchInnerprodsTempDetail(MAP.SEARCHSELECT_ID_MAP.PERSONAL['航旅国内旅客价值等级评估']);
    }
    ...
    handleOk() {
        ...
        this.props.action.clearMessage();
        this.props.action.clearTemplateData();
        this.props.action.fetchTemplateDataSearch(MAP.SEARCHSELECT_ID_MAP.PERSONAL['航旅国内旅客价值等级评估'], values);
    }
            ...
            <div className="fn-pa-10">
                <div className="panel">
                    <Tabs defaultActiveKey="1">
                        <TabPane tab="航旅国内旅客价值等级评估" key="1">
                            <h3>
                                {
    ...
    get report() {
        ...
        console.log("airTravelGrade",templateData)
        if(!templateData)
            return;
        return (<Report.airTravelGrade dataSource={{
            ...templateData.data,
            ...{
                base: {
...
export default connect(mapStateToProps, mapDispatchToProps)(createForm()(AirTravelGrade));
